...
def run(protocol):
    ...
    def transfer_volumes():
        ...
        for plate in plates_dict: 
            ...
            #     plate_types.append(SEMI_DEF)
            #     plate_labels.append(SEMI_LABEL)

        # define labware 
        if len(plate_names) >= 1: 
            if plate_types[0] == "semi": 
                plate1 = protocol.load_labware_from_definition(SEMI_DEF, plate_locations[0], SEMI_LABEL)  #!
            elif plate_types[0] == "full": 
                plate1 = protocol.load_labware(PLATE_TYPE_FULL, plate_locations[0])
            elif plate_types[0] == "semi_ice": 
                plate1 = protocol.load_labware_from_definition(SEMI_ICE_DEF, plate_locations[0], SEMI_ICE_LABEL)  
            else: 
            ...
            if len(plate_names) >= 2: 
                ...
                if plate_types[1] == "semi": 
                    plate2 = protocol.load_labware_from_definition(SEMI_DEF, plate_locations[1], SEMI_LABEL)  #!
                elif plate_types[1] == "full": 
                    plate2 = protocol.load_labware(PLATE_TYPE_FULL, plate_locations[1])
                elif plate_types[1] == "semi_ice": 
                    plate2 = protocol.load_labware_from_definition(SEMI_ICE_DEF, plate_locations[1], SEMI_ICE_LABEL)
                else: 
                ...
                if len(plate_names) >= 3: 
                    ...
                    if plate_types[2] == "semi": 
                        plate3 = protocol.load_labware_from_definition(SEMI_DEF, plate_locations[2], SEMI_LABEL)  #!
                    elif plate_types[2] == "full": 
                        plate3 = protocol.load_labware(PLATE_TYPE_FULL, plate_locations[2])
                    elif plate_types[2] == "semi_ice": 
                        plate3 = protocol.load_labware_from_definition(SEMI_ICE_DEF, plate_locations[2], SEMI_ICE_LABEL)
                    else: 
                    ...
                    if len(plate_names) >= 4: 
                        ...
                        if plate_types[3] == "semi": 
                            plate4 = protocol.load_labware_from_definition(SEMI_DEF, plate_locations[3], SEMI_LABEL)  #!
                        elif plate_types[3] == "full": 
                            plate4 = protocol.load_labware(PLATE_TYPE_FULL, plate_locations[3])
                        elif plate_types[3] == "semi_ice": 
                            plate4 = protocol.load_labware_from_definition(SEMI_ICE_DEF, plate_locations[3], SEMI_ICE_LABEL)
                        else: 
                        ...
                        if len(plate_names) >= 5: 
                            ...
                            if plate_types[4] == "semi": 
                                plate5 = protocol.load_labware_from_definition(SEMI_DEF, plate_locations[4], SEMI_LABEL) 
                            elif plate_types[4] == "full": 
                                plate5 = protocol.load_labware(PLATE_TYPE_FULL, plate_locations[4])
                            elif plate_types[4] == "semi_ice": 
                                plate5 = protocol.load_labware_from_definition(SEMI_ICE_DEF, plate_locations[4], SEMI_ICE_LABEL)
                            else: 
